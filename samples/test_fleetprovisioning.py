...
# Run the following AWS CLI to create a temporary provisioning claim certificate set
# aws iot create-provisioning-claim \
#         --template-name test_Provisioning_Template \
#         | python ~/dev/aws-iot-device-sdk-python-v2/utils/parse_cert_set_result.py \
#         --path ~/dev \
#         --filename provision

# Use temporary provisioning keys to perform the actual provisioning
# python ~/dev/aws-iot-device-sdk-python-v2/samples/test_fleetprovisioning.py \
#         --templateName test_Provisioning_Template \
#         --templateParameters "{\"SerialNumber\":\"1\",\"DeviceLocation\":\"Seattle\"}"
# The SerialNumber need to change to another number once the Thing is created
...
if __name__ == '__main__':
    ...
    if connection_args['use_websocket'] == True:
        ...
        mqtt_connection = mqtt_connection_builder.mtls_from_path(
            endpoint=connection_args['endpoint'],
            cert_filepath=connection_args['provision_cert'],
            pri_key_filepath=connection_args['provision_key'],
            client_bootstrap=client_bootstrap,
            ca_filepath=connection_args['root-ca'],
            client_id=args.client_id,
            on_connection_interrupted=on_connection_interrupted,
